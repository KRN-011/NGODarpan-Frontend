            ...
            <div className="h-screen w-full absolute top-0 left-0 z-0">
                <div className="h-full w-full flex items-center justify-center max-w-4xl mx-auto">
                    <motion.div className="flex flex-col items-center justify-center"
                        ...
                        transition={{ duration: 0.5, opacity: { delay: 3, duration: 0.4 }, scale: { delay: 4.5, duration: 0.25 }, y: { delay: 3, duration: 0.4 }, ease: "easeOut" }}
                    >
                                    ...
                                    "Welcome to NGO Darpan".split(/(\s+)/).map((part, index) => (
                                        part.trim() === "" ? part : (
                                            <motion.span
                                                ...
                                                animate={{ y: 0 }}
                                                exit={{ y: "100%" }}
                                                transition={{ duration: index * 1.5 + 0.5, y: { delay: index * 0.08 + 3.5, duration: 0.5 }, ease: "easeOut" }}
                                            >
                                                {part}
                                            </motion.span>
                                        )
